...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_file", "-t", nargs='?', default= "")
    parser.add_argument("--state_dir", "-s", nargs='?', default= "")
    parser.add_argument("--res_dir", "-r", nargs='?', default= "")
    ...
    if  args2.test_file:
        args.data.test_file = args2.test_file
    subcommands = {
        'evaluate': Evaluate(),
        'predict': Predict(),
        'train': Train()
